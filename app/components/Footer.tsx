          ...
          <div className="footer-col footer-col-contact">
            ...
            <p className="footer-address">
              <a
                ...
                title="Xem chỉ đường đến Vườn Mãng Cầu Bà Đen TAYNA trên Google Maps"
          ...
          <div className="footer-col footer-col-social">
            ...
            <div className="footer-social-buttons">
              <a
                ...
                aria-label="Facebook Fanpage TAYNA - Mãng Cầu Bà Đen"
              >
              ...
              <a
                ...
                aria-label="Nhắn tin Zalo TAYNA 0907 215 521"
              >
              ...
              <a
                ...
                aria-label="Kênh TikTok TAYNA Mãng Cầu Bà Đen"
              >
                <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" aria-hidden="true">
                  <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.97-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.82.55-1.36 1.48-1.44 2.47-.13 1.25.46 2.5 1.52 3.12 1.05.65 2.44.66 3.49.03.95-.55 1.58-1.57 1.66-2.67.06-2.64.04-5.29.04-7.93-.01-4.74-.01-9.48-.01-14.22z" />
                </svg>
                <span>TikTok</span>
              </a>
            </div>
