...
export const articles: Article[] = [
  {
    ...
    readTime: "6 phút đọc",
    description:
      "Hướng dẫn thuê xe lăn Núi Bà Đen chi tiết: Địa điểm đăng ký miễn phí tại quầy CSKH, cách đi cáp treo cùng xe lăn, tham quan đỉnh 986m và gợi ý lịch trình 1 ngày.",
  },
  {
