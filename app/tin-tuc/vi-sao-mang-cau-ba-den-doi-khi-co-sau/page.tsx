        ...
        <article className="article-layout">
          ...
          <div className="article-body">
            <div className="article-container article-prose">
              ...
              <InlineFigure src="/dong-mang-cau-xop-tay-ninh.jpg" alt="Đóng thùng carton bọc xốp hạn chế va đập" caption="Bao bì và cách xếp trái rất quan trọng khi vận chuyển mãng cầu đi xa." />
